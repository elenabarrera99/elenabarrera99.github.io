...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=3524389&appid=c9e3042008b963f420ce5b64bb77f439&units=imperial";
fetch(apiURL)
...
document.getElementById("hum").textContent = jsObject.main.humidity + "°F";
document.getElementById("wspeed").textContent = jsObject.wind.speed;
});

const apiFCURL = "https://api.openweathermap.org/data/2.5/forecast?id=3524389&appid=c9e3042008b963f420ce5b64bb77f439&units=imperial";
fetch(apiFCURL)
.then((response) => response.json())
.then((jsObject) => {
    console.log(jsObject);
