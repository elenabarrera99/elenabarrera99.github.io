/************Soda Spring Weather JS***********/
const apiSS = "https://api.openweathermap.org/data/2.5/weather?id=5678757&appid=c9e3042008b963f420ce5b64bb77f439&units=imperial";
fetch(apiSS)
...
const apiFCURL = "https://api.openweathermap.org/data/2.5/forecast?id=5678757&appid=c9e3042008b963f420ce5b64bb77f439&units=imperial";
fetch(apiFCURL)
.then((response) => response.json())
.then((jsObject) => {
    console.log(jsObject);
